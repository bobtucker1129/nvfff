...
const PublicMap = dynamic(() => import('@/components/PublicMap'), {
  ssr: false,
  loading: () => (
    <div className="w-full h-96 bg-stone-200 rounded-lg flex items-center justify-center animate-pulse">
...
export default function HomePage() {
  return (
    <div className="min-h-screen bg-[#f5f3ef] text-stone-900">
      ...
      <header className="sticky top-0 z-50 bg-white/80 backdrop-blur border-b border-stone-200">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <span className="font-serif text-2xl font-bold text-green-700 tracking-tight">
              NVFFF
            </span>
          ...
          <nav className="flex items-center gap-6 text-sm">
            <Link href="/" className="text-stone-600 hover:text-green-700 transition-colors duration-200">
              Home
            </Link>
            <a href="#the-map" className="text-stone-600 hover:text-green-700 transition-colors duration-200">
              The Map
            </a>
            <Link href="/login" className="text-stone-600 hover:text-green-700 transition-colors duration-200">
              Sign In
            </Link>
            <Link href="/signup" className="bg-green-700 hover:bg-green-600 text-white px-4 py-1.5 rounded text-sm font-medium transition-all duration-200 hover:shadow-lg hover:shadow-green-900/20">
              Join
            </Link>
          </nav>
        </div>
      ...
      <section className="relative overflow-hidden min-h-[80vh] flex items-center">
        ...
        <div className="relative max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-20 w-full">
          <div className="max-w-2xl">
            <p className="text-green-700 text-sm font-medium tracking-[0.2em] uppercase mb-6">
              Est. Northern Virginia
            </p>
            <h1 className="font-serif text-5xl sm:text-6xl lg:text-7xl font-bold text-stone-900 leading-[1.05] mb-8">
              Cold Water.<br />
              <span className="text-amber-600 italic">Cold Beer.</span><br />
              Good Company.
            </h1>
            <p className="text-stone-700 text-lg sm:text-xl mb-12 leading-relaxed max-w-lg">
              Northern Virginia&apos;s fly fishing collective. We log catches, share spots, and argue about flies.
            </p>
            <div className="flex flex-col sm:flex-row gap-4">
              <Link href="/signup" className="inline-block bg-green-700 hover:bg-green-600 text-white font-semibold px-8 py-3.5 rounded transition-all duration-200 hover:shadow-lg hover:shadow-green-900/30 text-center">
                Join the Fanatics
              </Link>
              <a href="#the-map" className="inline-block bg-white/80 backdrop-blur border border-stone-300 hover:border-green-600 text-stone-800 hover:text-green-700 font-semibold px-8 py-3.5 rounded transition-all duration-200 text-center">
                See the Map
              </a>
            </div>
          </div>
      ...
      {/* ── STATS BAR ── */}
      <section className="border-y border-stone-200 bg-white/80 backdrop-blur">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
          <div className="grid grid-cols-3 gap-8">
            <div className="text-center">
              <div className="font-serif text-4xl font-bold text-amber-600">47</div>
              <div className="text-stone-500 text-xs uppercase tracking-wider mt-2">Members</div>
            </div>
            <div className="text-center">
              <div className="font-serif text-4xl font-bold text-green-700">128</div>
              <div className="text-stone-500 text-xs uppercase tracking-wider mt-2">Catches Logged</div>
            </div>
            <div className="text-center">
              <div className="font-serif text-4xl font-bold text-stone-700">12</div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div>
              <p className="text-green-700 text-sm font-medium tracking-[0.2em] uppercase mb-4">Featured Catch</p>
      ...
      <section className="py-28 relative overflow-hidden">
        ...
        <div className="relative max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="relative pl-10">
            <span className="absolute left-0 top-0 text-green-600/40 text-6xl font-serif leading-none select-none" aria-hidden="true">
              &ldquo;
            </span>
            <p className="text-stone-700 text-xl sm:text-2xl leading-relaxed italic font-serif">
            ...
            <p className="text-green-700 font-bold mt-6 text-lg tracking-wide">
              NVFFF.
            </p>
          </div>
        </div>
      ...
      {/* ── PUBLIC MAP ── */}
      <section id="the-map" className="py-28 bg-stone-100">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mb-10">
          ...
          <div className="rounded-xl overflow-hidden border border-stone-200 shadow-2xl h-[480px]">
            <PublicMap />
          </div>
      ...
      <section className="py-28 relative overflow-hidden">
        <div className="absolute inset-0">
          ...
          />
          <div className="absolute inset-0 bg-gradient-to-b from-[#f5f3ef] via-[#f5f3ef]/90 to-[#f5f3ef]" />
        </div>
